...
module.exports.run = async(client, message, args, tools) => {
  ...
  if(!kanal) return message.reply({ content: "Bir sayı yazmalısın.  Örnek `l!sayaç #kanal 100`", allowedMentions: { repliedUser: false }})
  if(!sayi) return message.reply({ content: "Bir sayı yazmalısın.  Örnek `l!sayaç #kanal 100    `", allowedMentions: { repliedUser: false }})
